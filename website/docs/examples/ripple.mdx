...
Visit the [source code](https://github.com/gkurt/jsx-middlewares/blob/main/website/src/examples/ripple/index.tsx) of this example to see the full implementation.
